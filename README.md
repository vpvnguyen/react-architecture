...
- Presentation logic
- Data access logic (caches, databases, front-ends, etc.)
- Application layer logic / use case (applications like Google's Docs, Sheets, Maps, etc. set of use cases and policy that governs those use cases)
- Domain layer logic (Core business that doesn't quite fit within the confines of a single entity)
- Validation logic
- Core business logic
